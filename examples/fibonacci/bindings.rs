...
unsafe extern "C" {
    pub fn babybearextinv(a: u32, b: u32, c: u32, d: u32, i: u32) -> u32;
}
unsafe extern "C" {
    pub fn babybearinv(a: u32) -> u32;
}
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct C_PlonkBn254Proof {
    pub PublicInputs: [*mut ::std::os::raw::c_char; 2usize],
    pub EncodedProof: *mut ::std::os::raw::c_char,
    pub RawProof: *mut ::std::os::raw::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of C_PlonkBn254Proof"][::std::mem::size_of::<C_PlonkBn254Proof>() - 32usize];
    ["Alignment of C_PlonkBn254Proof"][::std::mem::align_of::<C_PlonkBn254Proof>() - 8usize];
    ["Offset of field: C_PlonkBn254Proof::PublicInputs"]
        [::std::mem::offset_of!(C_PlonkBn254Proof, PublicInputs) - 0usize];
    ["Offset of field: C_PlonkBn254Proof::EncodedProof"]
        [::std::mem::offset_of!(C_PlonkBn254Proof, EncodedProof) - 16usize];
    ["Offset of field: C_PlonkBn254Proof::RawProof"]
        [::std::mem::offset_of!(C_PlonkBn254Proof, RawProof) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct C_Groth16Bn254Proof {
    pub PublicInputs: [*mut ::std::os::raw::c_char; 2usize],
    pub EncodedProof: *mut ::std::os::raw::c_char,
    pub RawProof: *mut ::std::os::raw::c_char,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of C_Groth16Bn254Proof"][::std::mem::size_of::<C_Groth16Bn254Proof>() - 32usize];
    ["Alignment of C_Groth16Bn254Proof"][::std::mem::align_of::<C_Groth16Bn254Proof>() - 8usize];
    ["Offset of field: C_Groth16Bn254Proof::PublicInputs"]
        [::std::mem::offset_of!(C_Groth16Bn254Proof, PublicInputs) - 0usize];
    ["Offset of field: C_Groth16Bn254Proof::EncodedProof"]
        [::std::mem::offset_of!(C_Groth16Bn254Proof, EncodedProof) - 16usize];
    ["Offset of field: C_Groth16Bn254Proof::RawProof"]
        [::std::mem::offset_of!(C_Groth16Bn254Proof, RawProof) - 24usize];
};
...
unsafe extern "C" {
    pub fn ProvePlonkBn254(
        dataDir: *mut ::std::os::raw::c_char,
        witnessPath: *mut ::std::os::raw::c_char,
    ) -> *mut C_PlonkBn254Proof;
}
unsafe extern "C" {
    pub fn FreePlonkBn254Proof(proof: *mut C_PlonkBn254Proof);
}
unsafe extern "C" {
    pub fn BuildPlonkBn254(dataDir: *mut ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn VerifyPlonkBn254(
        dataDir: *mut ::std::os::raw::c_char,
        proof: *mut ::std::os::raw::c_char,
        vkeyHash: *mut ::std::os::raw::c_char,
        committedValuesDigest: *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn TestPlonkBn254(
        witnessPath: *mut ::std::os::raw::c_char,
        constraintsJson: *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn ProveGroth16Bn254(
        dataDir: *mut ::std::os::raw::c_char,
        witnessPath: *mut ::std::os::raw::c_char,
    ) -> *mut C_Groth16Bn254Proof;
}
unsafe extern "C" {
    pub fn FreeGroth16Bn254Proof(proof: *mut C_Groth16Bn254Proof);
}
unsafe extern "C" {
    pub fn BuildGroth16Bn254(dataDir: *mut ::std::os::raw::c_char);
}
unsafe extern "C" {
    pub fn VerifyGroth16Bn254(
        dataDir: *mut ::std::os::raw::c_char,
        proof: *mut ::std::os::raw::c_char,
        vkeyHash: *mut ::std::os::raw::c_char,
        committedValuesDigest: *mut ::std::os::raw::c_char,
...
unsafe extern "C" {
    pub fn TestGroth16Bn254(
        witnessJson: *mut ::std::os::raw::c_char,
        constraintsJson: *mut ::std::os::raw::c_char,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn TestPoseidonBabyBear2() -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
